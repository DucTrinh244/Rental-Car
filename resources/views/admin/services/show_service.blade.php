                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center gap-1">
                            ...
                            <a href="{{ URL::to('add-services') }}" class="btn btn-sm btn-primary">
                                Thêm dịch vụ
                            </a>
                        </div>
                        <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div
                                                                ...
                                                                <img src="{{ asset($service_item->image) }}"
                                                                    alt="{{ $service_item->image }}" class="avatar-md">
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                data-url="{{ URL::to('delete-service/' . $service_item->id) }}"
