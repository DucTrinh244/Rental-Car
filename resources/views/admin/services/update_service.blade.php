                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="service_name" id="service_name"
                                                class="form-control" value="{{ $service->service_name }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control bg-light-subtle" id="description" 
                                                name="service_desc" rows="7">{{ $service->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="category_status" id="category_status">
                                                <option value="0" {{ $service->status == 0 ? 'selected' : '' }}>Không hiển thị</option>
