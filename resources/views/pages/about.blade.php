...
@section('content')
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="4" data-background="public/FrontEnd/img/slider/3.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h6>DUCNHICAR</h6>
                        <h1>Giới thiệu về <span> Xe Đức Nhi</span></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        ...
                        <p>Bạn đang tìm kiếm một dịch vụ thuê xe giá rẻ, chất lượng, và đáng tin cậy? Chúng tôi cung cấp đa dạng các loại xe từ xe du lịch, xe tự lái, xe có tài xế đến xe sang trọng phục vụ nhu cầu cá nhân, gia đình, hoặc doanh nghiệp.</p>
                        <p class="mb-30">Dù bạn cần thuê xe ngắn hạn hay dài hạn, hãy liên hệ ngay để được tư vấn và nhận báo giá tốt nhất!</p>
    ...
    <!-- Video -->
    <section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="4" data-background="public/FrontEnd/img/slider/1.jpg">
        <div class="container">
            <div class="row">
