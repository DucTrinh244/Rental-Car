            ...
            <div class="owl-carousel owl-theme">
              <div class="item">
                ...
                <a href="car-details.html" class="img">
                  <img src="img/blog/8.jpg" alt="" class="img-fluid" />
              ...
              <div class="item">
                ...
                <a href="post.html" class="img">
                  <img src="img/blog/10.jpg" alt="" class="img-fluid" />
                  <div class="bottom-fade"></div>
                  <div class="arrow"><i class="ti-arrow-right"></i></div>
                </a>
                <div class="info">
              ...
              <div class="item">
                ...
                <a href="post.html" class="img">
                  <img src="img/blog/11.jpg" alt="" class="img-fluid" />
                  <div class="bottom-fade"></div>
                  <div class="arrow"><i class="ti-arrow-right"></i></div>
                </a>
                <div class="info">
              ...
              <div class="item">
                ...
                <a href="post.html" class="img">
                  <img src="img/blog/7.jpg" alt="" class="img-fluid" />
                  <div class="bottom-fade"></div>
                  <div class="arrow"><i class="ti-arrow-right"></i></div>
                </a>
                <div class="info">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="owl-carousel owl-theme">
              <div class="item">
                <img src="img/cars/03.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>Luxury Cars</h4>
                </div>
                <div class="curv-butn icon-bg">
              ...
              <div class="item">
                <img src="img/cars/04.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>Sport Cars</h4>
                </div>
                <div class="curv-butn icon-bg">
              ...
              <div class="item">
                <img src="img/cars/02.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>SUV</h4>
                </div>
                <div class="curv-butn icon-bg">
              ...
              <div class="item">
                <img src="img/cars/01.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>Convertible</h4>
                </div>
                <div class="curv-butn icon-bg">
              ...
              <div class="item">
                <img src="img/cars/05.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>Sedan</h4>
                </div>
                <div class="curv-butn icon-bg">
              ...
              <div class="item">
                <img src="img/cars/06.jpg" class="img-fluid" alt="" />
                <div class="title">
                  <h4>Small Cars</h4>
                </div>
                <div class="curv-butn icon-bg">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="owl-carousel owl-theme">
              ...
              <div class="item">
                <img src="img/blog/7.jpg" class="img-fluid" alt="" />
                <div class="bottom-fade"></div>
                <div class="title">
                  <h6>Rules</h6>
              ...
              <div class="item">
                <img src="img/blog/8.jpg" class="img-fluid" alt="" />
                <div class="bottom-fade"></div>
                <div class="title">
                  <h6>Rental Car</h6>
